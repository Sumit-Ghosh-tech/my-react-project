...
function ShopPage() {
    ...
    const filteredProducts = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_PRODUCTS"].filter((p)=>selectedCategory === "All" || p.category === selectedCategory).filter((p)=>p.price >= selectedPrice.min && p.price <= selectedPrice.max).sort((a, b)=>{
...
_s(ShopPage, "59HUtacfCR7Z4zsindz+ee8Desc=");
_c = ShopPage;
var _c;
...
//# sourceMappingURL=_120aa1cc._.js.map